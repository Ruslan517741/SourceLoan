...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autoplay, addInterval) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, autoplay, addInterval));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        ...
        if (slide.closest('button')) {
          ...
          _this2.container.insertBefore(slide, _this2.slides[_this2.slides.length - 3]);
        }
      });
    ...
    key: "startInterval",
    value: function startInterval(elem) {
      var _this4 = this;
    ...
    key: "stopInterval",
    value: function stopInterval(elem) {
      var _this5 = this;
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoplay) {
          this.interval();
          this.slides.forEach(function (slide) {
            _this6.startInterval(slide);

            _this6.stopInterval(slide);
          });
